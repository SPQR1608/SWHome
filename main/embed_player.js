...
;function yg(){this.b=xg()}
yg.prototype.f=function(){return{context:wg(this.b)}};
yg.prototype.g=function(a,b,c){T("VISITOR_DATA")||U(Error("Missing VISITOR_DATA when sending innertube request."));b={headers:{"Content-Type":"application/json","X-Goog-Visitor-Id":T("VISITOR_DATA","")},D:b,wa:"JSON",O:c.O,J:function(a,b){c.J&&c.J(b)},
onError:function(a,b){if(c.onError)c.onError(b)},
timeout:c.timeout,withCredentials:!0};var d=Ac();d&&(b.headers.Authorization=d,b.headers["X-Goog-AuthUser"]=T("SESSION_INDEX",0));d=this.b.nb;d.startsWith("http")||(d="//"+d);W("youtubei_for_web")&&(d="");var e=this.b.Oa;e&&(d=e);jf(""+d+("/youtubei/"+this.b.innertubeApiVersion+"/"+a)+"?alt=json&key="+this.b.innertubeApiKey,b)};var zg=r("yt.logging.latency.usageStats_")||{};q("yt.logging.latency.usageStats_",zg,void 0);var Ag=0;function Bg(a){zg[a]=zg[a]||{count:0};var b=zg[a];b.count++;b.time=pe();Ag||(Ag=pf(Cg,0));return 10<b.count?(11==b.count&&kf(Error("CSI data exceeded logging limit with key: "+a)),!0):!1}
function Cg(){var a=pe(),b;for(b in zg)6E4<a-zg[b].time&&delete zg[b];Ag=0}
;function Dg(a,b,c,d){Eg(a,{attachChild:{csn:b,parentVisualElement:ig(c),visualElements:[ig(d)]}},void 0)}
function Fg(a,b,c){c=Ca(c,function(a){return ig(a)});
Eg(a,{visibilityUpdate:{csn:b,visualElements:c}})}
function Eg(a,b,c){b.eventTimeMs=Math.round(pe());b.lactMs=ug();c&&(b.clientData=Gg(c));og({endpoint:"log_interaction",va:b},a)}
function Gg(a){var b={};a.analyticsChannelData&&(b.analyticsDatas=Ca(a.analyticsChannelData,function(a){return{tabName:a.tabName,cardName:a.cardName,isChannelScreen:a.isChannelScreen,insightId:a.insightId,externalChannelId:a.externalChannelId,externalContentOwnerId:a.externalContentOwnerId}}));
return{playbackData:{clientPlaybackNonce:a.clientPlaybackNonce},analyticsChannelData:b,externalLinkData:a.externalLinkData}}
;function Hg(){if(!Ig&&!Jg||!window.JSON)return null;var a;try{a=Ig.get("yt-player-two-stage-token")}catch(b){}if(!u(a))try{a=Jg.get("yt-player-two-stage-token")}catch(b){}if(!u(a))return null;try{a=JSON.parse(a,void 0)}catch(b){}return a}
var Jg,Kg=new ne;Jg=Kg.isAvailable()?new je(Kg):null;var Ig,Lg=new oe;Ig=Lg.isAvailable()?new je(Lg):null;function Mg(){var a=T("ROOT_VE_TYPE",void 0);return a?new gg(void 0,a,void 0):null}
function Ng(){var a=T("client-screen-nonce",void 0);a||(a=T("EVENT_ID",void 0));return a}
;var Og={},Pg=0;function Qg(a,b){a&&(T("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)?df(a,b):Rg(a,b))}
function Rg(a,b){var c=new Image,d=""+Pg++;Og[d]=c;c.onload=c.onerror=function(){b&&Og[d]&&b();delete Og[d]};
c.src=a}
;function Sg(a,b){this.version=a;this.args=b}
;function Tg(a){this.topic=a}
Tg.prototype.toString=function(){return this.topic};var Ug=r("yt.pubsub2.pubsub2.instance_")||new R;R.prototype.subscribe=R.prototype.subscribe;R.prototype.unsubscribeByKey=R.prototype.K;R.prototype.publish=R.prototype.V;R.prototype.clear=R.prototype.clear;q("yt.pubsub2.pubsub2.instance_",Ug,void 0);var Vg=r("yt.pubsub2.pubsub2.subscribedKeys_")||{};q("yt.pubsub2.pubsub2.subscribedKeys_",Vg,void 0);var Wg=r("yt.pubsub2.pubsub2.topicToKeys_")||{};q("yt.pubsub2.pubsub2.topicToKeys_",Wg,void 0);var Xg=r("yt.pubsub2.pubsub2.isAsync_")||{};
q("yt.pubsub2.pubsub2.isAsync_",Xg,void 0);q("yt.pubsub2.pubsub2.skipSubKey_",null,void 0);function Yg(a){var b=Zg,c=r("yt.pubsub2.pubsub2.instance_");c&&c.publish.call(c,b.toString(),b,a)}
;var X=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function $g(a,b){Sg.call(this,1,arguments)}
z($g,Sg);var Zg=new Tg("timing-sent");var ah=x().toString();var bh={vc:!0},ch={ad_at:"adType",cpn:"clientPlaybackNonce",csn:"clientScreenNonce",is_nav:"isNavigation",yt_lt:"loadType",yt_ad:"isMonetized",yt_ad_pr:"prerollAllowed",yt_red:"isRedSubscriber",yt_vis:"isVisible",docid:"videoId",plid:"videoId"},dh="ap c cver ei yt_fss yt_li".split(" "),eh=["isNavigation","isMonetized","prerollAllowed","isRedSubscriber","isVisible"],fh=v(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||
t,X);
function gh(a){if("_"!=a[0]){var b=a;X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b))}var b=hh(),c=pe();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;ih()["tick_"+a]=void 0;pe();W("csi_on_gel")?(b=jh(),"_start"==a?Bg("baseline_"+b)||vg("latencyActionBaselined",{clientActionNonce:b},yg,void 0):Bg("tick_"+a+"_"+b)||vg("latencyActionTicked",{tickName:a,clientActionNonce:b},yg,void 0),a=!0):a=!1;if(a=!a)a=!r("yt.timing.pingSent_");if(a&&(b=T("TIMING_ACTION",void 0),a=hh(),r("yt.timing.ready_")&&
b&&a._start&&kh())){b=!0;c=T("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&lh()}}
function mh(){var a=nh().info.yt_lt="hot_bg";ih().info_yt_lt=a;if(W("csi_on_gel"))if("yt_lt"in ch){var b={},c=ch.yt_lt;0<=Ba(eh,c)&&(a=!!a);b[c]=a;a=jh();c=Object.keys(b).join("");Bg("info_"+c+"_"+a)||(b.clientActionNonce=a,vg("latencyActionInfo",b,yg))}else"yt_lt"in dh||U(Error("Unknown label yt_lt logged with GEL CSI."))}
function kh(){var a=hh();if(a.aft)return a.aft;for(var b=T("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function lh(){if(!W("csi_on_gel")){var a=hh(),b=nh().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&na(a[d])){var e=d.slice(1);if(e in bh){var f=Ca(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=r("yt.timing.reportbuilder_")){if(f=f(a,b,void 0))oh(f,e),ph(),fh(),qh(!1,void 0),T("TIMING_ACTION")&&S("PREVIOUS_ACTION",T("TIMING_ACTION")),S("TIMING_ACTION","")}else{var g=T("CSI_SERVICE_NAME","youtube"),f={v:2,s:g,action:T("TIMING_ACTION",void 0)},h=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var k=window.location.protocol+r("ytplayer.config.assets.js");(k=X.getEntriesByName?X.getEntriesByName(k)[0]:null)?b.h5jse=Math.round(b.h5jse-k.responseEnd):
delete b.h5jse}a.aft=kh();rh()&&"youtube"==g&&(mh(),g=a.vc,k=a.pbs,delete a.aft,b.aft=Math.round(k-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=pe();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=r("ytdebug.logTiming"))&&a(f,b);oh(f,e,void 0);Yg(new $g(b.aft+(h||0),void 0))}}}
function oh(a,b,c){if(W("debug_csi_data")){var d=r("yt.timing.csiData");d||(d=[],q("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}var d="",e;for(e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b)try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")||Qg(a,void 0)}catch(f){Qg(a,void 0)}else Qg(a);qh(!0,c)}
function jh(){var a=nh().nonce;if(!a){var b;a:{if(window.crypto&&window.crypto.getRandomValues)try{var c=Array(16),d=new Uint8Array(16);window.crypto.getRandomValues(d);for(a=0;a<c.length;a++)c[a]=d[a];b=c;break a}catch(e){}b=Array(16);for(c=0;16>c;c++){d=x();for(a=0;a<d%23;a++)b[c]=Math.random();b[c]=Math.floor(256*Math.random())}if(ah)for(c=1,d=0;d<ah.length;d++)b[c%16]=b[c%16]^b[(c-1)%16]/4^ah.charCodeAt(d),c++}c=[];for(d=0;d<b.length;d++)c.push("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_".charAt(b[d]&
63));a=c.join("");nh().nonce=a}return a}
function hh(){return nh().tick}
function ih(){var a=nh();"gel"in a||(a.gel={});return a.gel}
function nh(){return r("ytcsi.data_")||ph()}
function ph(){var a={tick:{},info:{}};q("ytcsi.data_",a,void 0);return a}
function qh(a,b){q("yt.timing."+(b||"")+"pingSent_",a,void 0)}
function rh(){var a=hh(),b=a.pbr,c=a.vc,a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==nh().info.yt_pvis}
;function sh(a,b){P.call(this);this.w=this.l=a;this.T=b;this.C=!1;this.g={};this.Z=this.S=null;this.U=new R;zd(this,w(Ad,this.U));this.j={};this.L=this.aa=this.i=this.ha=this.b=null;this.W=!1;this.M=this.B=this.H=this.R=null;this.ba={};this.Ca=["onReady"];this.X=new dg(this);zd(this,w(Ad,this.X));this.fa=null;this.oa=NaN;this.Y={};th(this);this.G("onDetailedError",v(this.Ta,this));this.G("onTabOrderChange",v(this.Ea,this));this.G("onTabAnnounce",v(this.pa,this));this.G("WATCH_LATER_VIDEO_ADDED",v(this.Ua,
...
z(sh,P);var uh=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];l=sh.prototype;l.na=function(a,b){this.f||(vh(this,a),wh(this,b),this.C&&xh(this))};
function vh(a,b){a.ha=b;a.b=zf(b);a.i=a.b.attrs.id||a.i;"video-player"==a.i&&(a.i=a.T,a.b.attrs.id=a.T);a.w.id==a.i&&(a.i+="-player",a.b.attrs.id=a.i);a.b.args.enablejsapi="1";a.b.args.playerapiid=a.T;a.aa||(a.aa=yh(a,a.b.args.jsapicallback||"onYouTubePlayerReady"));a.b.args.jsapicallback=null;var c=a.b.attrs.width;c&&(a.w.style.width=Ub(Number(c)||c));if(c=a.b.attrs.height)a.w.style.height=Ub(Number(c)||c)}
...
function zh(a){if(!p(a.b.disable.flash)){var b=a.b.disable,c;c=Jf(If.getInstance(),a.b.minVersion);b.flash=!c}return!a.b.disable.flash}
function Ah(a,b){if((!b||(5!=(Pf[b.errorCode]||5)?0:-1!=uh.indexOf(b.errorCode)))&&zh(a)){var c=Bh(a);c&&c.stopVideo&&c.stopVideo();var d=a.b;c&&c.getUpdatedConfigurationData&&(c=c.getUpdatedConfigurationData(),d=yf(c));d.args.autoplay=1;d.args.html5_unavailable="1";vh(a,d);wh(a,"flash")}}
function wh(a,b){if(!a.f){if(!b){var c;if(!(c=!a.b.html5&&zh(a))){if(!p(a.b.disable.html5)){var d;c=!0;void 0!=a.b.args.deviceHasDisplay&&(c=a.b.args.deviceHasDisplay);if(2.2==Qf)d=!0;else{a:{var e=c;c=r("yt.player.utils.videoElement_");c||(c=document.createElement("VIDEO"),q("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType)for(var e=e?Yf:Zf,f=0;f<e.length;f++)if(c.canPlayType(e[f])){d=null;break a}d="fmt.noneavailable"}catch(g){d="html5.missingapi"}}d=!d}d&&(d=Ch(a)||a.b.assets.js);
...
function Ch(a){var b=!0,c=Bh(a);c&&a.b&&(a=a.b,b=ve(c,"version")==a.assets.js);return b&&!!r("yt.player.Application.create")}
l.mb=function(){if(!this.W){var a=Ch(this);if(a&&"html5"==Dh(this))this.L="html5",this.C||this.P();else if(Eh(this),this.L="html5",a&&this.H)this.l.appendChild(this.H),this.P();else{this.b.loaded=!0;var b=!1;this.R=v(function(){b=!0;var a=this.l,d=zf(this.b);r("yt.player.Application.create")(a,d);this.P()},this);
this.W=!0;a?this.R():(Pe(this.b.assets.js,this.R),Lf(this.b.assets.css),Fh(this)&&!b&&q("yt.player.Application.create",null,void 0))}}};
l.lb=function(){var a=zf(this.b);if(!this.B){var b=Bh(this);b&&(this.B=document.createElement("SPAN"),this.B.tabIndex=0,eg(this.X,this.B,"focus",this.ta),this.M=document.createElement("SPAN"),this.M.tabIndex=0,eg(this.X,this.M,"focus",this.ta),b.parentNode&&b.parentNode.insertBefore(this.B,b),b.parentNode&&b.parentNode.insertBefore(this.M,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==Dh(this))this.L="flash",this.C||this.P();else{Eh(this);this.L=
...
l.ta=function(){Bh(this).focus()};
function Bh(a){var b=Ob(a.i);!b&&a.w&&a.w.querySelector&&(b=a.w.querySelector("#"+a.i));return b}
l.P=function(){if(!this.f){var a=Bh(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.W=!1,a.isNotServable&&a.isNotServable(this.b.args.video_id))Ah(this);else{th(this);this.C=!0;a=Bh(this);a.addEventListener&&(this.S=Gh(this,a,"addEventListener"));a.removeEventListener&&(this.Z=Gh(this,a,"removeEventListener"));for(var b=a.getApiInterface(),b=b.concat(a.getInternalApiInterface()),c=0;c<b.length;c++){var d=b[c];this.g[d]||(this.g[d]=Gh(this,a,d))}for(var e in this.j)this.S(e,
this.j[e]);xh(this);this.aa&&this.aa(this.g);this.U.V("onReady",this.g)}else this.oa=V(v(this.P,this),50)}};
function Gh(a,b,c){var d=b[c];return function(){try{return a.fa=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.fa=e,U(e,"WARNING"))}}}
function th(a){a.C=!1;if(a.Z)for(var b in a.j)a.Z(b,a.j[b]);for(var c in a.Y)window.clearTimeout(parseInt(c,10));a.Y={};a.S=null;a.Z=null;for(var d in a.g)a.g[d]=null;a.g.addEventListener=v(a.G,a);a.g.removeEventListener=v(a.bb,a);a.g.destroy=v(a.dispose,a);a.g.getLastError=v(a.Ia,a);a.g.getPlayerType=v(a.Ja,a);a.g.getCurrentVideoConfig=v(a.Ha,a);a.g.loadNewVideoConfig=v(a.na,a);a.g.isReady=v(a.ob,a)}
l.ob=function(){return this.C};
l.G=function(a,b){if(!this.f){var c=yh(this,b);if(c){if(!(0<=Ba(this.Ca,a)||this.j[a])){var d=Hh(this,a);this.S&&this.S(a,d)}this.U.subscribe(a,c);"onReady"==a&&this.C&&V(w(c,this.g),0)}}};
l.bb=function(a,b){if(!this.f){var c=yh(this,b);c&&ce(this.U,a,c)}};
function yh(a,b){var c=b;if("string"==typeof b){if(a.ba[b])return a.ba[b];c=function(){var a=r(b);a&&a.apply(n,arguments)};
a.ba[b]=c}return c?c:null}
function Hh(a,b){var c="ytPlayer"+b+a.T;a.j[b]=c;n[c]=function(c){var d=V(function(){if(!a.f){a.U.V(b,c);var e=a.Y,g=String(d);g in e&&delete e[g]}},0);
Za(a.Y,String(d))};
return c}
...
l.Ja=function(){return this.L||Dh(this)};
l.Ia=function(){return this.fa};
function Dh(a){return(a=Bh(a))?"div"==a.tagName.toLowerCase()?"html5":"flash":null}
function Eh(a){gh("dcp");a.cancel();th(a);a.L=null;a.b&&(a.b.loaded=!1);var b=Bh(a);"html5"==Dh(a)?Ch(a)||!Fh(a)?a.H=b:(b&&b.destroy&&b.destroy(),a.H=null):b&&b.destroy&&b.destroy();for(var b=a.l,c;c=b.firstChild;)b.removeChild(c);fg(a.X);a.B=null;a.M=null}
l.cancel=function(){this.R&&Oe(this.b.assets.js,this.R);window.clearTimeout(this.oa);this.W=!1};
l.o=function(){Eh(this);if(this.H&&this.b)try{this.H.destroy()}catch(b){U(b)}this.ba=null;for(var a in this.j)n[this.j[a]]=null;this.ha=this.b=this.g=null;delete this.l;delete this.w;sh.A.o.call(this)};
function Fh(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var Ih={},Jh="player_uid_"+(1E9*Math.random()>>>0);function Kh(a,b){a=u(a)?Ob(a):a;b=yf(b);var c=Jh+"_"+ra(a),d=Ih[c];if(d)return d.na(b),d.g;d=new sh(a,c);Ih[c]=d;Fe("player-added",d.g);zd(d,w(Lh,d));V(function(){d.na(b)},0);
return d.g}
function Lh(a){Ih[a.T]=null}
function Mh(a){a=Ob(a);if(!a)return null;var b=Jh+"_"+ra(a),c=Ih[b];c||(c=new sh(a,b),Ih[b]=c);return c.g}
;function Nh(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=T("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){var d=a,e=T("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=Wb(K(window.location.href)[3]||null);f&&e.push(f);f=Wb(K(d)[3]||null);if(0<=Ba(e,f)||!f&&0==d.lastIndexOf("/",0))if(W("autoescape_tempdata_url")&&(e=document.createElement("a"),Nb(e,d),d=e.href),d){var f=K(d),d=f[5],e=f[6],f=f[7],g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
Ng();d="ST-"+Aa(d).toString(36);e=b?Ze(b):"";zc.set(""+d,e,5,"/","youtube.com");b&&(b=b.itct||b.ved,d=r("yt.logging.screen.storeParentElement"),b&&d&&d(new gg(b)))}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var h,k,m;h=void 0===h?{}:h;k=void 0===k?"":k;m=void 0===m?window:m;c=m.location;a=Xb(Zb([a],h))+k;a=a instanceof Fb?a:Jb(a);c.href=Hb(a)}return!0}
;var Oh=r("yt.abuse.botguardInitialized")||Se;q("yt.abuse.botguardInitialized",Oh,void 0);var Ph=r("yt.abuse.invokeBotguard")||Te;q("yt.abuse.invokeBotguard",Ph,void 0);var Qh=r("yt.abuse.dclkstatus.checkDclkStatus")||tf;q("yt.abuse.dclkstatus.checkDclkStatus",Qh,void 0);var Rh=r("yt.player.exports.navigate")||Nh;q("yt.player.exports.navigate",Rh,void 0);var Sh=r("yt.player.embed")||Kh;q("yt.player.embed",Sh,void 0);var Th=r("yt.player.getPlayerByElement")||Mh;q("yt.player.getPlayerByElement",Th,void 0);
var Uh=r("yt.util.activity.init")||sg;q("yt.util.activity.init",Uh,void 0);var Vh=r("yt.util.activity.getTimeSinceActive")||ug;q("yt.util.activity.getTimeSinceActive",Vh,void 0);var Wh=r("yt.util.activity.setTimestamp")||tg;q("yt.util.activity.setTimestamp",Wh,void 0);function Xh(a){this.b=a||xg();Yh||(Yh=Zh(this.b))}
function Zh(a){return(new Q(function(b){try{var c={gapiHintOverride:a.gapiHintOverride,_c:{jsl:{h:a.gapiHintParams}},callback:b},d=pa(c)?{callback:c}:c||{};d._c&&d._c.jsl&&d._c.jsl.h||bb(d,{_c:{jsl:{h:T("GAPI_HINT_PARAMS",void 0)}}});if(d.gapiHintOverride||T("GAPI_HINT_OVERRIDE")){var e;var f=document.location.href;if(-1!=f.indexOf("?")){var f=(f||"").split("#")[0],g=f.split("?",2);e=Xe(1<g.length?g[1]:g[0])}else e={};var h=e.gapi_jsh;h&&bb(d,{_c:{jsl:{h:h}}})}ed("client",d)}catch(k){U(k)}})).then(function(){})}
Xh.prototype.i=function(){var a=r("gapi.config.update");a("googleapis.config/auth/useFirstPartyAuth",!0);var b=this.b.apiaryHost;/^[\s\xa0]*$/.test(null==b?"":String(b))||a("googleapis.config/root",(-1==b.indexOf("://")?"//":"")+b);b=this.b.Da;/^[\s\xa0]*$/.test(null==b?"":String(b))||a("googleapis.config/root-1p",(-1==b.indexOf("://")?"//":"")+b);b=T("SESSION_INDEX");a("googleapis.config/sessionIndex",b);r("gapi.client.setApiKey")(this.b.innertubeApiKey)};
Xh.prototype.f=function(){return{context:wg(this.b)}};
Xh.prototype.g=function(a,b,c){var d,e=!1;0<c.timeout&&(d=V(function(){e||(e=!0,c.O&&c.O())},c.timeout));
$h(this,a,b,function(a){if(!e)if(e=!0,d&&window.clearTimeout(d),a)c.J&&c.J(a);else if(c.onError)c.onError()})};
function $h(a,b,c,d){var e={path:"/youtubei/"+a.b.innertubeApiVersion+"/"+b,headers:{"X-Goog-Visitor-Id":T("VISITOR_DATA")},method:"POST",body:Fd(c)},f=v(a.i,a);Yh.then(function(){f();r("gapi.client.request")(e).execute(d||t)})}
var Yh=null;function ai(){return W("enable_youtubei_innertube")?yg:Xh}
;function bi(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function ci(a,b,c){u(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return di(a)}
function di(a,b,c){if(qa(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function ei(a,b,c,d){if(qa(a)&&!na(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}c={index:b,startSeconds:c,suggestedQuality:d};u(a)&&16==a.length?c.list="PL"+a:c.playlist=a;return c}
function fi(a){var b=a.video_id||a.videoId;if(u(b)){var c=Hg()||{},d=Hg()||{};p(void 0)?d[b]=void 0:delete d[b];var e=x()+3E5,f=Jg;if(f&&window.JSON){u(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;function gi(a){P.call(this);this.g=a;this.g.subscribe("command",this.xa,this);this.i={};this.j=!1}
z(gi,P);l=gi.prototype;l.start=function(){this.j||this.f||(this.j=!0,hi(this.g,"RECEIVING"))};
l.xa=function(a,b){if(this.j&&!this.f){var c=b||{};switch(a){case "addEventListener":if(u(c.event)&&(c=c.event,!(c in this.i))){var d=v(this.eb,this,c);this.i[c]=d;this.addEventListener(c,d)}break;case "removeEventListener":u(c.event)&&ii(this,c.event);break;default:this.b.isReady()&&this.b[a]&&(c=ji(a,b||{}),c=this.b[a].apply(this.b,c),(c=ki(a,c))&&this.j&&!this.f&&hi(this.g,a,c))}}};
l.eb=function(a,b){this.j&&!this.f&&hi(this.g,a,this.ia(a,b))};
l.ia=function(a,b){if(null!=b)return{value:b}};
function ii(a,b){b in a.i&&(a.removeEventListener(b,a.i[b]),delete a.i[b])}
l.o=function(){var a=this.g;a.f||ce(a.b,"command",this.xa,this);this.g=null;for(var b in this.i)ii(this,b);gi.A.o.call(this)};function li(a,b){gi.call(this,b);this.b=a;this.start()}
z(li,gi);li.prototype.addEventListener=function(a,b){this.b.addEventListener(a,b)};
li.prototype.removeEventListener=function(a,b){this.b.removeEventListener(a,b)};
function ji(a,b){switch(a){case "loadVideoById":return b=di(b),fi(b),[b];case "cueVideoById":return b=di(b),fi(b),[b];case "loadVideoByPlayerVars":return fi(b),[b];case "cueVideoByPlayerVars":return fi(b),[b];case "loadPlaylist":return b=ei(b),fi(b),[b];case "cuePlaylist":return b=ei(b),fi(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];
...
li.prototype.ia=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return li.A.ia.call(this,a,b)};
li.prototype.o=function(){li.A.o.call(this);delete this.b};function mi(a,b,c,d){P.call(this);this.g=b||null;this.B="*";this.i=c||null;this.sessionId=null;this.channel=d||null;this.H=!!a;this.w=v(this.C,this);window.addEventListener("message",this.w)}
aa(mi,P);
mi.prototype.C=function(a){if(!("*"!=this.i&&a.origin!=this.i||this.g&&a.source!=this.g)&&u(a.data)){var b;try{b=Dd(a.data)}catch(c){return}if(!(null==b||this.H&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin?this.i=this.B=a.origin:U(Error("MessageEvent origin is null"),"WARNING");this.g=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.j&&(this.l&&!(0<=Ba(this.l,b.func))||this.j(b.func,
b.args))}}};
mi.prototype.sendMessage=function(a,b){var c=b||this.g;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=Fd(a);c.postMessage(d,this.B)}catch(e){U(e,"WARNING")}}};
mi.prototype.o=function(){window.removeEventListener("message",this.w);P.prototype.o.call(this)};function ni(a,b,c){mi.call(this,a,b,c||T("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.l=this.b=this.j=null}
aa(ni,mi);function oi(){var a=!!T("WIDGET_ID_ENFORCE"),a=this.f=new ni(a),b=v(this.ab,this);a.j=b;a.l=null;this.f.channel="widget";if(a=T("WIDGET_ID"))this.f.sessionId=a;this.i=[];this.l=!1;this.j={}}
l=oi.prototype;l.ab=function(a,b){if("addEventListener"==a&&b){var c=b[0];this.j[c]||"onReady"==c||(this.addEventListener(c,pi(this,c)),this.j[c]=!0)}else this.Aa(a,b)};
l.Aa=function(){};
function pi(a,b){return v(function(a){this.sendMessage(b,a)},a)}
...
mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());this.b.getStoryboardFormat&&(a.storyboardFormat=this.b.getStoryboardFormat());qi(this,a)};
l.fb=function(a){qi(this,{playbackQuality:a})};
l.gb=function(a){qi(this,{playbackRate:a})};
...
l.jb=function(){qi(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
l.ib=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:x()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());qi(this,a)};
l.dispose=function(){ri.A.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function si(){P.call(this);this.b=new R;zd(this,w(Ad,this.b))}
z(si,P);si.prototype.subscribe=function(a,b,c){return this.f?0:this.b.subscribe(a,b,c)};
si.prototype.K=function(a){return this.f?!1:this.b.K(a)};
si.prototype.l=function(a,b){this.f||this.b.V.apply(this.b,arguments)};function ti(a,b,c){si.call(this);this.g=a;this.i=b;this.j=c}
z(ti,si);function hi(a,b,c){if(!a.f){var d=a.g;d.f||a.i!=d.b||(a={id:a.j,command:b},c&&(a.data=c),d.b.postMessage(Fd(a),d.i))}}
ti.prototype.o=function(){this.i=this.g=null;ti.A.o.call(this)};function ui(a,b,c){P.call(this);this.b=a;this.i=c;this.j=Gf(window,"message",v(this.l,this));this.g=new ti(this,a,b);zd(this,w(Ad,this.g))}
z(ui,P);ui.prototype.l=function(a){var b;if(b=!this.f)if(b=a.origin==this.i)a:{b=this.b;do{var c;b:{c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(a=a.data,u(a))){try{a=Dd(a)}catch(d){return}a.command&&(b=this.g,b.f||b.l("command",a.command,a.data))}};
ui.prototype.o=function(){Hf(this.j);this.b=null;ui.A.o.call(this)};function vi(){var a=$a(wi);return new Q(function(b,c){a.J=function(a){We(a)?b(a):c(new xi("Request failed, status="+a.status,"net.badstatus"))};
a.onError=function(){c(new xi("Unknown request error","net.unknown"))};
a.O=function(){c(new xi("Request timed out","net.timeout"))};
cf("//googleads.g.doubleclick.net/pagead/id",a)})}
function xi(a,b){B.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
aa(xi,B);function yi(a){B.call(this,a.message||a.description||a.name);this.Pa=a instanceof zi;this.b=a instanceof Td}
z(yi,B);yi.prototype.name="BiscottiError";function zi(){B.call(this,"Biscotti ID is missing from server")}
z(zi,B);zi.prototype.name="BiscottiMissingError";function Ai(a,b){this.f=a;this.b=b}
Ai.prototype.then=function(a,b,c){try{if(p(this.f))return a?Qd(a.call(c,this.f)):Qd(this.f);if(p(this.b)){if(!b)return Rd(this.b);var d=b.call(c,this.b);return!p(d)&&this.b.b?Rd(this.b):Qd(d)}throw Error("Invalid Result_ state");}catch(e){return Rd(e)}};
Ld(Ai);var wi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Bi=null;function Ci(){if(!Bi){var a=v(Di,n,2),b=vi().then(Ei);Bi=Sd(b,null,a,void 0)}return Bi}
function Ei(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new zi;a=JSON.parse(a.substr(4)).id;Fi(a);Bi=new Ai(a);Gi(18E5,2);return a}
function Di(a,b){var c=new yi(b);Fi("");Bi=new Ai(void 0,c);0<a&&Gi(12E4,a-1);throw c;}
function Gi(a,b){V(function(){var a=v(Di,n,b),a=vi().then(Ei,a);Sd(a,null,t,void 0)},a)}
function Fi(a){q("yt.ads.biscotti.lastId_",a,void 0)}
;function Hi(a){a.Pa&&Ii("")}
function Ji(a){!a||r("yt.ads.biscotti.getId_")||r("yt.www.ads.biscotti.getId_")||q("yt.ads.biscotti.getId_",Ci,void 0);try{var b;try{var c=r("yt.ads.biscotti.getId_")||r("yt.www.ads.biscotti.getId_");b=c?c():Ci()}catch(d){b=Rd(d)}b.then(Ii,Hi);V(Ji,18E5)}catch(d){U(d)}}
var Ki=0;
function Ii(a){var b;a:{try{b=window.top.location.href}catch(G){b=2;break a}b=null!=b?b==window.document.location.href?0:1:2}b={dt:ic,flash:Ta||"0",frm:b};b.u_tz=-(new Date).getTimezoneOffset();var c;try{c=A.history.length}catch(G){c=0}b.u_his=c;b.u_java=!!A.navigator&&"unknown"!==typeof A.navigator.javaEnabled&&!!A.navigator.javaEnabled&&A.navigator.javaEnabled();A.screen&&(b.u_h=A.screen.height,b.u_w=A.screen.width,b.u_ah=A.screen.availHeight,b.u_aw=A.screen.availWidth,b.u_cd=A.screen.colorDepth);A.navigator&&
...
for(var ta in d)b[ta]=d[ta]}b.bsq=Ki++;jf("//www.youtube.com/ad_data_204",{Ka:!1,D:b})}
;function Li(){this.b=T("ALT_PREF_COOKIE_NAME","PREF");var a=zc.get(""+this.b,void 0);if(a)for(var a=unescape(a).split("&"),b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}
la(Li);var Y=r("yt.prefs.UserPrefs.prefs_")||{};q("yt.prefs.UserPrefs.prefs_",Y,void 0);function Mi(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
function Ni(a){if(!/^\w+$/.test(a))throw Error("ExpectedRegexMismatch: "+a);}
function Oi(a){a=void 0!==Y[a]?Y[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
Li.prototype.get=function(a,b){Ni(a);Mi(a);var c=void 0!==Y[a]?Y[a].toString():null;return null!=c?c:b?b:""};
Li.prototype.set=function(a,b){Ni(a);Mi(a);if(null==b)throw Error("ExpectedNotNull");Y[a]=b.toString()};
Li.prototype.remove=function(a){Ni(a);Mi(a);delete Y[a]};
Li.prototype.clear=function(){Y={}};q("yt.pubsub.publish",Fe,void 0);var Pi=null,Qi=null,Ri=null,Si={};function Ti(a){vg(a.payload_name,a.payload,W("enable_youtubei_innertube")?yg:Xh,void 0,void 0)}
function Ui(a){var b=a.id;a=a.ve_type;var c=hg++;a=new gg(void 0,a,c,void 0);Si[b]=a;b=Ng();c=Mg();b&&c&&Dg(ai(),b,c,a)}
function Vi(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(S("client-screen-nonce",b),S("ROOT_VE_TYPE",a),a=Mg()))for(var c in Si){var d=b,e=a,f=Si[c];Dg(ai(),d,e,f)}}
function Wi(a){Si[a.id]=new gg(a.tracking_params)}
function Xi(a){var b=Ng();a=Si[a.id];if(b&&a){var c=ai();Eg(c,{click:{csn:b,visualElement:ig(a)}},void 0)}}
function Yi(a){a=a.ids;var b=Ng();if(b){for(var c=[],d=0;d<a.length;d++){var e=Si[a[d]];e&&c.push(e)}c.length&&Fg(ai(),b,c)}}
function Zi(){var a=Pi;a&&a.startInteractionLogging&&a.startInteractionLogging()}
...
q("writeEmbed",function(){var a=T("PLAYER_CONFIG",void 0);"1"!=a.privembed&&Ji(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=T("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);T("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&fi(a.args);Pi=a=Kh("player",a);a.addEventListener("onScreenChanged",Vi);a.addEventListener("onLogClientVeCreated",Ui);a.addEventListener("onLogServerVeCreated",Wi);a.addEventListener("onLogToGel",
Ti);a.addEventListener("onLogVeClicked",Xi);a.addEventListener("onLogVesShown",Yi);a.addEventListener("onReady",Zi);b=T("POST_MESSAGE_ID","player");T("ENABLE_JS_API")?Ri=new ri(a):T("ENABLE_POST_API")&&u(b)&&u(c)&&(Qi=new ui(window.parent,b,c),Ri=new li(a,Qi.g));T("BG_P")&&(T("BG_I")||T("BG_IU"))&&Re();sf()},void 0);
q("yt.www.watch.ads.restrictioncookie.spr",function(a){Qg(a+"mac_204?action_fcts=1");return!0},void 0);
var $i=xe(function(){gh("ol");var a=Li.getInstance(),b=1<window.devicePixelRatio;if(!!((Oi("f"+(Math.floor(119/31)+1))||0)&67108864)!=b){var c="f"+(Math.floor(119/31)+1),d=Oi(c)||0,d=b?d|67108864:d&-67108865;0==d?delete Y[c]:Y[c]=d.toString(16).toString();var a=a.b,b=[],e;for(e in Y)b.push(e+"="+escape(Y[e]));zc.set(""+a,b.join("&"),63072E3,"/","youtube.com")}}),aj=xe(function(){var a=Pi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();T("PL_ATT")&&(Qe=null);for(var a=0,b=qf.length;a<b;a++){var c=qf[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):window.clearTimeout(c)}}qf.length=0;a=Le("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))Ee(a),b.parentNode.removeChild(b);rf=!1;S("DCLKSTAT",0);Bd(Ri,Qi);if(a=Pi)a.removeEventListener("onScreenChanged",Vi),a.removeEventListener("onLogClientVeCreated",Ui),a.removeEventListener("onLogServerVeCreated",
Wi),a.removeEventListener("onLogToGel",Ti),a.removeEventListener("onLogVeClicked",Xi),a.removeEventListener("onLogVesShown",Yi),a.removeEventListener("onReady",Zi),a.destroy();Si={}});
window.addEventListener?(window.addEventListener("load",$i),window.addEventListener("unload",aj)):window.attachEvent&&(window.attachEvent("onload",$i),window.attachEvent("onunload",aj));}).call(this);
